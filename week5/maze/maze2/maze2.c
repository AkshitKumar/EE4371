    ...
    while(!found){
        ...
        if(i > 0 && i <= 9){
            if(maze[i-1][j] == 2 && maze[i-1][j] != 3 && maze[i-1][j] != 5){
                ...
                distanceArray[i-1][j] = min_distance + 15;
                distanceArray_copy[i-1][j] = min_distance + 15;
            }
        ...
        if(j > 0 && j <= 9){
            if(maze[i][j-1] == 2 && maze[i][j-1] != 3 && maze[i][j-1] != 5){
                ...
                distanceArray[i][j-1] = min_distance + 15;
                distanceArray_copy[i][j-1] = min_distance + 15;
            }
